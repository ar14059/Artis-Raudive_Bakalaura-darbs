...
def get_relationships_data(rel_uri, rel_type = ""):
    data = get_kitsu_data_by_uri(rel_uri, headers)
    ...
    for data_el in data:
        ...
        for key, val in data_el.items():
            ...
            second_level = [("castings","person"), ("characters", "character"), 
                            ("castings", "person"), ("staff", "person"), 
                            ("staff", "person"), ("production", "company"),]
...
ex_uri = "https://kitsu.io/api/edge/anime/3/genres"
ex_rel_data = json.dumps(get_relationships_data(ex_uri))
# print(ex_rel_data)
```
