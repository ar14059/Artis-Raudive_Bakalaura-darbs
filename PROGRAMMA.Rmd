...
```{python}
k = "posterImage"
v = {"tiny":"https://media.kitsu.io/anime/poster_images/10/tiny.jpg?1495114402",
...
# def image_data_parser(val, key_uri):
#     img_id = {}
#     img_data = {}
#     img_size = ["tiny", "small", "medium", "large"]
#     for img_key, img_val in val.items():
#         if(img_key in img_size):
#             new_key = key_uri + "/" + img_key
#             if(not_empty(img_val)):
#                 img_id.update({new_key:[schema_val(img_val)]})
#     return 
...
def spec_val(key, val):
    if("youtube" in key.lower() or "yt" in key.lower()):
        ...
        return val
# print(spec_val("youtubeVideoId","9aS-EgdAq6U"))
